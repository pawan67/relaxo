    ...
    <>
      <div className="pt-6 flex text-[#142D4C] dark:text-white justify-between items-center w-screen  font-poppins font-semibold  container lg mx-auto">
        <a href="https://relaxo.vercel.app/">
          <div className=" ml-10  font-bold  dark:text-[#142D4C] hover:shadow-2xl hover:cursor-pointer transition-all px-9 p-4 shadow-md rounded-2xl mt-5 inline-block bg-[#9FD3C7] text-xl ">
            Relaxo
          </div>
        </a>
        ...
        <a href="https://github.com/pawan67/relaxo">
          <div className=" mr-10 hover:shadow-2xl dark:text-[#142D4C] hover:cursor-pointer transition-all text-xl px-9 font-bold p-4 shadow-md rounded-2xl mt-5 inline-block bg-[#9FD3C7]">
            Github
          </div>
        </a>
      </div>
